...
def create_sample_message(message_id: int, message_type: str = "sample") -> Dict[str, Any]:
    """
...
class MessageStats:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "receive_rate": round(self.received_count / elapsed, 2) if elapsed > 0 else 0,
        }
    
    def print_stats(self):
        """Print current statistics."""
        stats = self.get_stats()
        print(f"📊 Stats: Sent={stats['sent_count']}, "
